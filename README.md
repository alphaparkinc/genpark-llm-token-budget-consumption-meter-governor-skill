# genpark-llm-token-budget-consumption-meter-governor-skill
...
> **GenPark AI Agent Skill** -- Self-custody LLM API key usage meter & token budget governor (Lettertrace style)
